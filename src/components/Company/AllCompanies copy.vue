<template>
  <v-col cols="12" sm="12" class="my-16">
    <v-row justify="center">
      <!-- 搜尋欄 -->
      <v-col cols="12" class="search-bar">
        <v-text-field
          class="mx-auto"
          density="comfortable"
          placeholder="搜尋"
...
export default {
  data: () => ({
    ...
    values1: null,
    values2: null,
    items1: ['foo', 'bar', 'baz'], // Option 1 的選項
    items2: ['找設計', '找餐具', '找家具', '找設備', '找原料', '其他項目'], // Option 2 的選項
    populars: [
      { image: 'image/1.png', title: 'Enjoy The Beauty Place in Greece City', link: '/singlestore' },
      { image: 'image/2.png', title: 'Enjoy The Beauty Place in Maldives Beach', link: '/singlestore' },
      { image: 'image/3.png', title: 'Enjoy The Beauty Place in Bhutan City', link: '/singlestore' },
      { image: 'image/4.png', title: 'Enjoy The Beauty Place in Paris City', link: '/singlestore' },
      { image: 'image/1.png', title: 'Enjoy The Beauty Place in Greece City', link: '/singlestore' },
      { image: 'image/2.png', title: 'Enjoy The Beauty Place in Maldives Beach', link: '/singlestore' },
      { image: 'image/3.png', title: 'Enjoy The Beauty Place in Bhutan City', link: '/singlestore' },
      { image: 'image/4.png', title: 'Enjoy The Beauty Place in Paris City', link: '/singlestore' },
